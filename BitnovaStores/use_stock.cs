...
{
    public partial class use_stock : Form
    {
        ...
        private void use_stock_Load(object sender, EventArgs e)
        {
            GetRecords();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                GetRecords();
                ds = new DataSet();
                adapter = new MySqlDataAdapter("insert into usedstock(name,qty,category,supplier,tdate) VALUES('" + dataGridViewProduct[1, i].Value.ToString() + "','" + txtQty.Text + "','" + dataGridViewProduct[3, i].Value.ToString() + "','" + dataGridViewProduct[4, i].Value.ToString() + "','" + DateTime.Now.ToString("yyyyMMdd") + "')", con);
