...
{
    public partial class LiveOrdersReport : Form
    {
        ...
        public LiveOrdersReport()
        {
            InitializeComponent();
        }

        private void LiveOrdersReport_Load(object sender, EventArgs e)
        {
            GetRecords();
        }
        ...
        {
            ds = new DataSet();
            adapter = new MySqlDataAdapter("select * from orders where status like 'live'", con);
        ...
        private void pictureBox11_Click(object sender, EventArgs e)
        {
            ...
            print.AddLineBreak();
            print.AddString("<h3>Live Orders Report</h3>");
